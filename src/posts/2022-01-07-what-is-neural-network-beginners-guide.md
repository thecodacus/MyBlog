...
We are going to use a python library called “***[Keras](https://web.archive.org/web/20201125060732/https://keras.io/)***” which is a wrapper class for neural network library “***theano/tensorfow”.***  In this tutorial we are going to use [theano](https://web.archive.org/web/20201125060732/http://deeplearning.net/software/theano/) as backend library for Keras, Which is available for Win/Linux/Mac so that everyone can follow along.
